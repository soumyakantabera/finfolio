              ...
              <Grid container spacing={0}>
                {home.stats.map((stat, i) => (
                  ...
                  >
                    ...
                    <Typography
                      variant="caption"
                      sx={{ color: '#111', textTransform: 'uppercase', letterSpacing: '0.12em', fontWeight: 600, fontSize: { xs: '0.65rem', md: '0.75rem' }, fontFamily: accentFont }}
                    >
                      {stat.label}
                    </Typography>
                  </Grid>
          ...
          <Container maxWidth="lg" sx={{ py: { xs: 5, md: 14 }, px: { xs: 2, md: 5 }, textAlign: 'center' }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Button
                ...
                variant="outlined"
                size="large"
                sx={{ color: '#111', borderColor: '#E0E0E0', borderRadius: 0, boxShadow: 'none', minHeight: 48, px: { xs: 3, md: 4 }, '&:hover': { borderColor: '#000', bgcolor: '#000', color: '#FFF', boxShadow: 'none' } }}
              >
                Contact page
              </Button>
            </Box>
