          ...
          <Card variant="outlined" sx={{ mb: 3, border: '1px solid #eee' }}>
            <CardContent sx={{ p: 2 }}>
              {contact.email && (
                <Box
                  ...
                  sx={{
                    ...
                    borderBottom: '1px solid #f0f0f0', textDecoration: 'none', color: '#111',
                    minHeight: 48,
                    '&:hover': { fontWeight: 700 },
                    '&:focus-visible': { outline: '2px solid #000', outlineOffset: '2px' },
                  }}
                >
                  <EmailIcon sx={{ color: '#111', fontSize: 20 }} />
              ...
              {contact.phone && (
                ...
                >
                  <PhoneIcon sx={{ color: '#111', fontSize: 20 }} />
              ...
              {contact.address && (
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, py: 1.5, minHeight: 48 }}>
                  <LocationOnIcon sx={{ color: '#111', fontSize: 20 }} />
        ...
        <Grid size={{ xs: 12, md: 7 }}>
          <Box component="form" onSubmit={handleSubmit} noValidate>
            ...
            <Button
              ...
              variant="contained"
              size="large"
              sx={{ bgcolor: '#111', minHeight: 48, px: 4, '&:hover': { bgcolor: '#111' } }}
            >
              Send Message
            </Button>
          </Box>
