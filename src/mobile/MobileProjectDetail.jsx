    ...
    <>
      ...
      <Box sx={{ px: 'var(--page-pad-x)', py: 'var(--section-gap)', pb: '80px' }}>
        ...
        <Box
          ...
          sx={{
            mb: 3,
            '& img': { maxWidth: '100%', height: 'auto', border: '1px solid #E0E0E0' },
            '& iframe': { maxWidth: '100%', border: '1px solid #E0E0E0' },
            '& pre': { overflow: 'auto', maxWidth: '100%', border: '1px solid #E0E0E0', p: 1.5, fontSize: '0.75rem' },
          }}
        >
          <BlockRenderer
