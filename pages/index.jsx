                ...
                <Grid size={{ xs: 12, md: 5 }}>
                  ...
                  >
                    ...
                    {[
                      ...
                      >
                        <Typography variant="caption" sx={{ color: '#555', textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600, fontFamily: accentFont, fontSize: '0.7rem' }}>
                          {row.label}
                        </Typography>
                  ...
                  {allProjects.slice(0, 6).map((project) => (
                    <Grid size={{ xs: 12, sm: 6, md: 4 }} key={project.id}>
                      ...
                      >
                        <Typography
                          variant="overline"
                          sx={{ color: '#555', display: 'block', mb: 1, fontWeight: 600, fontFamily: accentFont }}
                        >
                          {project.category}
                        </Typography>
                        ...
                        {project.tags?.length > 0 && (
                          <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap', mb: 2 }}>
                            {project.tags.map((tag) => (
                              <Chip key={tag} label={tag} size="small" variant="outlined" sx={{ borderColor: '#E0E0E0', color: '#555', fontFamily: accentFont, borderRadius: 0 }} />
                            ))}
                          </Box>
                        )}
                        <Box
                        ...
                        >
                          {project.date && (
                            <Typography variant="caption" sx={{ color: '#555', fontFamily: accentFont }}>
                              {project.date}
                            </Typography>
                          )}
